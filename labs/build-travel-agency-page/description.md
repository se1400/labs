...
12. The three anchor elements should have an `img` element with an appropriate `alt` attribute and a `src` attribute set to a valid image as their content. You can use `https://se1400.github.io/labs/labs/assets/colosseo.jpg`, `https://se1400.github.io/labs/labs/assets/alps.jpg`, and `https://se1400.github.io/labs/labs/assets/sea.jpg` if you would like.
