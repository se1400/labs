...
11. You should have one `img` element with a `src` attribute set to a valid image, you can use `https://se1400.github.io/labs/assets/recipe.jpg` if you would like, and an `alt` attribute describing the image.
